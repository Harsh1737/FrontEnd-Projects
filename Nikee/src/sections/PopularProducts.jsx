...
import PopularProdectCard from '../Components/PopularProductsCard';
const PopularProdects = () => {
  return (
    <section id='products'
    className='max-container max-sm:mt-12'>
      <div className='flex flex-col justify-start gap-5'>
      <h2 className='text-4xl font-montserrat font-bold'>Our 
...
export default PopularProdects